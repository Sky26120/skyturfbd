                ...
                <div className="footer__content">
                    ...
                    <div className='footer__column'>
                        ...
                        <nav className='footer__column-nav-wrap'>
                            ...
                            <Link href='/testdashboard/user' className='footer__column-nav-item-link'>
                    ...
                    <div className='footer__column'>
                        ...
                        <address className='footer__address-text'>1/1, Meghna Shopping Complex, Rafikul Islam Road, Gobindapur, Sanir Akhra 1236 Dhaka, Bangladesh</address>
