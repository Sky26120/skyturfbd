...
const DashboardTableRow = ({slotDataAtt}) => {
  return (
    <>    
        {
            slotDataAtt.map((currElem) => {
                return (
                    <>
                        <tr>
                            <td>{currElem.slot}</td>
                            <td><input type="text" value={currElem.name}/></td>
                            <td><input type="text" value={currElem.contact}/></td>
                            <td><input type="text" value={currElem.location}/></td>
                            <td><input type="text" value={currElem.advance}/></td>
                            <td><input type="text" value={currElem.advanceReceiver}/></td>
                            <td><input type="text" value={currElem.total}/></td>
                            <td><input type="text" value={currElem.dueReceiver}/></td>
                            <td><input type="text" value={currElem.bookingPerson}/></td>
                            <td>
                                <select name="" id="">
